...
class TUIRangeSlider extends StatelessWidget {
  ...
  ///   min: 1.0,
  ///   max: 10.0,
  ///   onChanged: (TUIRangeValues newValues) {
  ///     setState(() {
  ...
  final ValueChanged<TUIRangeValues>? onChanged;
  ...
  ///     });
  ///   },
  ///   onChangeStart: (TUIRangeValues startValues) {
  ...
  ///    complete.
  final ValueChanged<TUIRangeValues>? onChangeStart;
  ...
  ///     });
  ///   },
  ///   onChangeEnd: (TUIRangeValues endValues) {
  ...
  ///    begins.
  final ValueChanged<TUIRangeValues>? onChangeEnd;
...
typedef TUIRangeValues = RangeValues;
